...
> :warning: Если в коде студента расскоментирована строка `exports.isStar = true;`, то нужно проверить выполнение дополнительного задания, если нет – то проверять не нужно, даже если студент начал его выполнение, но не закончил.
